# !/bin/bash
# this program echos ./simbin/dmd/polsqu2x2anneal4well_strech.f90
...
echo !'*''*'
echo !'*''*'' '
echo !'*''*'' 'Date:' '11/17/2021
echo !'*''*'
echo !'*''*'' 'Title:' '2x2' 'Polarize' 'Square' 'Model' 'with' 'a' 'Streched' 'Dipole
echo !'*''*'' '
...
echo !'*''*'
echo !'*''*'' '' '' '' '' '' '' '' '' '' 'The' 'dipoles' 'in' 'this' 'model' 'are' 'streched,' 'which
echo !'*''*'' '' '' '' '' '' '' '' '' '' 'means' 'that' 'rather' 'than' 'being' 'placed' 'in' 'the' 'center
echo !'*''*'' '' '' '' '' '' '' '' '' '' 'of' 'hard' 'spheres,' 'they' 'are' 'located' 'slightly' 'outside
echo !'*''*'' '' '' '' '' '' '' '' '' '' 'of' 'the' 'center.' 'In' 'this' 'case,' 'the' 'dipole' 'is' '1.5' 'times
echo !'*''*'' '' '' '' '' '' '' '' '' '' 'longer' 'along' 'the' 'axis' 'that' 'the' 'dipole' 'points.
echo !'*''*'
echo !'*''*'' '' '' '' '' '' '' '' '' '' 'This' 'simulation' 'incorperated' 'cell' '+' 'neighbor' 'list,
echo !'*''*'' '' '' '' '' '' '' '' '' '' 'beinary' 'tree,' 'and' 'false' 'positioning' 'DMD' 'efficiency
echo !'*''*'' '' '' '' '' '' '' '' '' '' 'techniques.' '' '
echo !'*''*'
echo !'*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*'
echo 
...
echo integer,' 'parameter' '::' 'mer' '=' '6' '!' 'number' 'of' 'hardspheres' 'which' 'make' 'one' 'cube' '"("4' 'hard' 'spheres' '+' '2' 'polarized' 'spheres")"
...
echo real"("kind=dbl")",' 'parameter' '::' 'sigma2' '=' '0.85' ''*'' 'sigma1' '!' 'distance' 'from' 'sphere' 'center' 'to' 'second' 'discontinuity
echo real"("kind=dbl")",' 'parameter' '::' 'sigma3' '=' '0.95' ''*'' 'sigma1' '!' 'distance' 'from' 'sphere' 'center' 'to' 'third' 'discontinuity
echo real"("kind=dbl")",' 'parameter' '::' 'sigma4' '=' '1.15' ''*'' 'sigma1' '!' 'distance' 'from' 'sphere' 'center' 'to' 'fourth' 'discontinuity
echo real"("kind=dbl")",' 'parameter' '::' 'sigma5' '=' '1.4' ''*'' 'sigma1' '!' 'distance' 'from' 'sphere' 'center' 'to' 'fifth' 'discontinuity
echo real"("kind=dbl")",' 'parameter' '::' 'epsilon1' '=' '1.0000' '!' 'reduced' 'energy' 'parameter
echo real"("kind=dbl")",' 'parameter' '::' 'epsilon2' '=' '2.5426' ''*'' 'epsilon1' '!' 'depth' 'of' 'first' 'well
echo real"("kind=dbl")",' 'parameter' '::' 'epsilon3' '=' '1.5916' ''*'' 'epsilon1' '!' 'depth' 'of' 'second' 'well' '
echo real"("kind=dbl")",' 'parameter' '::' 'epsilon4' '=' '0.8259' ''*'' 'epsilon1' '!' 'depth' 'of' 'third' 'well
echo real"("kind=dbl")",' 'parameter' '::' 'epsilon5' '=' '0.3146' ''*'' 'epsilon1' '!' 'depth' 'of' 'fourth' 'well
...
echo real"("kind=dbl")",' 'parameter' '::' 'sg4sq' '=' 'sigma4' ''*''*'' '2
echo real"("kind=dbl")",' 'parameter' '::' 'sg5sq' '=' 'sigma5' ''*''*'' '2
...
echo real"("kind=dbl")",' 'parameter' '::' 'ipol1bond' '=' '"("sigma1' '/' '8.")"' '-' 'delta' '!' 'inner' 'first' 'polarized' 'bond
echo real"("kind=dbl")",' 'parameter' '::' 'opol1bond' '=' '"("sigma1' '/' '8.")"' '+' 'delta' '!' 'outer' 'first' 'polarized' 'bond
echo real"("kind=dbl")",' 'parameter' '::' 'ipol2bond' '=' '"("9.' ''*'' 'sigma1' '/' '8.")"' '-' 'delta' '!' 'inner' 'second' 'polarized' 'bond
echo real"("kind=dbl")",' 'parameter' '::' 'opol2bond' '=' '"("9.' ''*'' 'sigma1' '/' '8.")"' '+' 'delta' '!' 'outer' 'second' 'polarized' 'bond
...
echo real"("kind=dbl")",' 'parameter' '::' 'orderwidth' '=' 'sigma5
echo 
echo 
...
echo real"("kind=dbl")",' 'parameter' '::' 'nbrRadiusMin' '=' '"("nbrRadiusMinInt' '/' '"("nbrRadiusMinInt' '-' '1")"")"' ''*'' '"("sigma5' '-' '"("sigma1' '/' 'nbrRadiusMinInt")"")"' '!' 'minimum' 'required' 'radius
...
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("m' ''<'=' '"("mer' '-' '2")"")"' 'then' '!' 'if' 'a' 'hard' 'sphere
...
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'else' '!' 'if' 'a' 'polarized' 'sphere
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("m' '==' '"("mer' '-' '1")"")"' 'then' '!' 'if' 'the' 'first' 'polarized' 'sphere
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'location' 'of' 'the' 'first' 'polarized' 'sphere' 'is' 'based' 'on' 'the' 'location' 'of' 'the' 'first' 'hard' 'sphere
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"("i")"'%'circle"("m")"'%'fpos'%'r"("1")"' '=' 'square"("i")"'%'circle"("1")"'%'fpos'%'r"("1")"' '+' '"("sigma1' '/' '8.")"' ''*'' 'cos"("theta' '-' 'halfpi")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"("i")"'%'circle"("m")"'%'fpos'%'r"("2")"' '=' 'square"("i")"'%'circle"("1")"'%'fpos'%'r"("2")"' '+' '"("sigma1' '/' '8.")"' ''*'' 'sin"("theta' '-' 'halfpi")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"("m' '==' '"("mer")"")"' 'then' '!' 'if' 'the' 'second' 'polarized' 'sphere
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"("i")"'%'circle"("m")"'%'fpos'%'r"("1")"' '=' 'square"("i")"'%'circle"("2")"'%'fpos'%'r"("1")"' '+' '"("sigma1' '/' '8.")"' ''*'' 'cos"("-"("theta' '+' 'halfpi")"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"("i")"'%'circle"("m")"'%'fpos'%'r"("2")"' '=' 'square"("i")"'%'circle"("2")"'%'fpos'%'r"("2")"' '+' '"("sigma1' '/' '8.")"' ''*'' 'sin"("theta' '+' 'halfpi")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'endif
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'endif
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '!' 'apply' 'periodic' 'boundary' 'conditions
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("square"("i")"'%'circle"("m")"'%'fpos'%'r"("q")"' ''<'' '0.0")"' 'square"("i")"'%'circle"("m")"'%'fpos'%'r"("q")"' '=' ''&'
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"("i")"'%'circle"("m")"'%'fpos'%'r"("q")"' '+' 'region
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("square"("i")"'%'circle"("m")"'%'fpos'%'r"("q")"' ''>'' 'region")"' 'square"("i")"'%'circle"("m")"'%'fpos'%'r"("q")"' '=' ''&'
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"("i")"'%'circle"("m")"'%'fpos'%'r"("q")"' '-' 'region
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if' '
echo 
...
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'do' 'n' '=' '1,' '"("mer' '-' '2")"' '!' 'for' 'all' 'hard' 'spheres' 'in' 'each' 'square
...
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '"("real"("randori")"' ''*'' 'halfpi")"' '+' '"("m' '-' '1")"' ''*'' 'halfpi")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'elseif' '"("m' '==' '"("mer' '-' '1")"")"' 'then' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"(""("x' '-' '1")"' ''*'' 'cell' '+' 'y")"'%'circle"("m")"'%'fpos'%'r"("1")"' '=' 'square"(""("x' '-' '1")"' ''*'' 'cell' '+' 'y")"'%'circle"("1")"'%'fpos'%'r"("1")"' '+' ''&'
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '"("sigma1' '/' '8.")"' ''*'' 'cos"("ori' '+' '"("real"("randori")"' ''*'' 'halfpi")"' '-' '"("pi' '/' '4.")"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"(""("x' '-' '1")"' ''*'' 'cell' '+' 'y")"'%'circle"("m")"'%'fpos'%'r"("2")"' '=' 'square"(""("x' '-' '1")"' ''*'' 'cell' '+' 'y")"'%'circle"("1")"'%'fpos'%'r"("2")"' '+' ''&'
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '"("sigma1' '/' '8.")"' ''*'' 'sin"("ori' '+' '"("real"("randori")"' ''*'' 'halfpi")"' '-' '"("pi' '/' '4.")"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'elseif' '"("m' '==' 'mer")"' 'then' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"(""("x' '-' '1")"' ''*'' 'cell' '+' 'y")"'%'circle"("m")"'%'fpos'%'r"("1")"' '=' 'square"(""("x' '-' '1")"' ''*'' 'cell' '+' 'y")"'%'circle"("2")"'%'fpos'%'r"("1")"' '+' ''&'
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '"("sigma1' '/' '8.")"' ''*'' 'cos"("ori' '+' '"("real"("randori")"' ''*'' 'halfpi")"' '+' '"("3.' ''*'' 'pi' '/' '4.")"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"(""("x' '-' '1")"' ''*'' 'cell' '+' 'y")"'%'circle"("m")"'%'fpos'%'r"("2")"' '=' 'square"(""("x' '-' '1")"' ''*'' 'cell' '+' 'y")"'%'circle"("2")"'%'fpos'%'r"("2")"' '+' ''&'
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '"("sigma1' '/' '8.")"' ''*'' 'sin"("-"("ori' '+' '"("real"("randori")"' ''*'' 'halfpi")"' '-' '"("pi' '/' '4.")"")"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'endif
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' 'group
echo ' '' '' '' '' '' '' '' 'end' 'do' 'y_axis
...
echo ' '' '' '' 'do' 'i' '=' '1,' 'cube' '
echo ' '' '' '' '' '' '' '' 'do' 'm' '=' '1,' 'mer' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'if' '"(""(""("square"("i")"'%'chai' '==' '1")"' '.and.' '"("m' '==' '"("mer' '-' '1")"")"")"' '.or.' '"(""("square"("i")"'%'chai' '==' '2")"' '.and.' '"("m' '==' 'mer")"")"")"' 'then' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'square"("i")"'%'circle"("m")"'%'pol' '=' '1' '!' 'positive' 'charge
echo ' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"(""(""("square"("i")"'%'chai' '==' '2")"' '.and.' '"("m' '==' '"("mer' '-' '1")"")"")"' '.or.' '"(""("square"("i")"'%'chai' '==' '1")"' '.and.' '"("m' '==' 'mer")"")"")"' 'then' '' '
...
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"("pol1bonded' '"("a'%'two,' 'b'%'two")"' '.and.' 'pol1overlap' '"("d")"")"' 'then' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'check_bond' '=' '.true.
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'write' '"("simiounit,' '5")"' 'a'%'two,' 'b'%'two,' 'a'%'one,' 'd' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '5' 'format' '"("\"' 'check_boundaries:' 'circles' '\",' 'I3,' '\"' 'and' '\",' 'I3,' '\"' 'of' 'square' '\",' 'I3' ''&'
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' ',' '\"' 'are' 'pol1-bonded' 'and' 'overlapping' '"("\",' 'F6.2,' '\"")".\"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"("pol2bonded' '"("a'%'two,' 'b'%'two")"' '.and.' 'pol2overlap' '"("d")"")"' 'then' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'check_bond' '=' '.true.
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'write' '"("simiounit,' '6")"' 'a'%'two,' 'b'%'two,' 'a'%'one,' 'd' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '6' 'format' '"("\"' 'check_boundaries:' 'circles' '\",' 'I3,' '\"' 'and' '\",' 'I3,' '\"' 'of' 'square' '\",' 'I3' ''&'
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' ',' '\"' 'are' 'pol2-bonded' 'and' 'overlapping' '"("\",' 'F6.2,' '\"")".\"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'endif' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"(""("b'%'one' ''>'' 'a'%'one")"' '.and.' '"("b'%'two' ''<'=' '"("mer' '-' '2")"")"' '.and.' '"("a'%'two' ''<'=' '"("mer' '-' '2")"")"")"' 'then' '!' 'if' 'b' 'is' 'uplist' 'of' 'a' 'and' 'they' 'not' 'on' 'the' 'same' 'group' '
...
echo ' '' '' '' 'if' '"(""(""(""("j-i")"' '==' '1")"' '.or.' '"(""("j-i")"' '==' '3")"")"' '.and.' '"("j' ''<'=' '"("mer' '-' '2")"")"")"' 'then' '!' 'if' 'the' 'two' 'spheres' 'are' 'next' 'to' 'one' 'another
...
echo 
echo logical' 'function' 'pol1bonded' '"("i,' 'j")"' '
echo ' '' '' '' 'implicit' 'none' '
echo ' '' '' '' '!' ''*''*'' 'calling' 'variables' ''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*'
echo ' '' '' '' 'integer,' 'intent' '"("in")"' '::' 'i,' 'j' '!' 'sphere' 'identifiers
echo ' '' '' '' '!' ''*''*'' 'local' 'variables' ''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*'
echo 
echo ' '' '' '' 'pol1bonded' '=' '.false.' '
echo ' '' '' '' 'if' '"(""(""("i' '==' '1")"' '.and.' '"("j' '==' '5")"")"' '.or.' '"(""("i' '==' '2")"' '.and.' '"("j' '==' '6")"")"")"' 'then' '
echo ' '' '' '' '' '' '' '' 'pol1bonded' '=' '.true.
echo ' '' '' '' 'endif
echo end' 'function' 'pol1bonded
echo 
echo logical' 'function' 'pol2bonded' '"("i,' 'j")"' '
echo ' '' '' '' 'implicit' 'none' '
echo ' '' '' '' '!' ''*''*'' 'calling' 'variables' ''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*'
echo ' '' '' '' 'integer,' 'intent' '"("in")"' '::' 'i,' 'j' '!' 'sphere' 'identifiers
echo ' '' '' '' '!' ''*''*'' 'local' 'variables' ''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*'
echo 
echo ' '' '' '' 'pol2bonded' '=' '.false.' '
echo ' '' '' '' 'if' '"(""(""("i' '==' '2")"' '.and.' '"("j' '==' '5")"")"' '.or.' '"(""("i' '==' '1")"' '.and.' '"("j' '==' '6")"")"")"' 'then' '
echo ' '' '' '' '' '' '' '' 'pol2bonded' '=' '.true.
echo ' '' '' '' 'endif
echo end' 'function' 'pol2bonded
echo 
...
echo 
echo logical' 'function' 'pol1overlap"("distance")"
echo ' '' '' '' 'implicit' 'none
echo ' '' '' '' 'real"("kind=dbl")",' 'intent"("in")"' '::' 'distance
echo ' '' '' '' '
echo ' '' '' '' 'pol1overlap' '=' '"("distance' ''>'' '"("opol1bond' '+' 'tol")"")"' '.or.' '"("distance' ''<'' '"("ipol1bond' '-' 'tol")"")"
echo end' 'function' 'pol1overlap
echo 
echo logical' 'function' 'pol2overlap"("distance")"
echo ' '' '' '' 'implicit' 'none
echo ' '' '' '' 'real"("kind=dbl")",' 'intent"("in")"' '::' 'distance
echo ' '' '' '' '
echo ' '' '' '' 'pol2overlap' '=' '"("distance' ''>'' '"("opol2bond' '+' 'tol")"")"' '.or.' '"("distance' ''<'' '"("ipol2bond' '-' 'tol")"")"
echo end' 'function' 'pol2overlap
echo 
...
echo ' '' '' '' 'write"("annealiounit,'*'")"' '\'id,' 'set,' 'actual,' 'total,' 'potential,' 'kinetic,' 'h2ts,' 'ht2o,' 'anti,' 'poly2,' 'full,' 'fulls,' 'fullo,\','&'
echo ' '' '' '' '' '' '' '' '\'poly1aa,' 'poly1abba,' 'poly1bb,' 'poly1,' 'percolation,' 'nclust,' 'nematic\'
echo 
...
echo ' '' '' '' 'write"("reportiounit,' ''*'")"' '\'' 'well' '3' 'depth' ',' '\',' 'epsilon4
echo ' '' '' '' 'write"("reportiounit,' ''*'")"' '\'' 'well' '3' 'length' ',' '\',' 'sigma4
echo ' '' '' '' 'write"("reportiounit,' ''*'")"' '\'' 'well' '3' 'depth' ',' '\',' 'epsilon5
echo ' '' '' '' 'write"("reportiounit,' ''*'")"' '\'' 'well' '3' 'length' ',' '\',' 'sigma5
...
echo ' '' '' '' '' '' '' '' '\'' 'poly1abba,' 'poly1abba_fluc,' 'poly1bb,' 'poly1bb_fluc,' 'poly1,' 'poly1_fluc,' 'percolation,' 'nclust,' 'nclust_fluc\'
...
echo ' '' '' '' '' '' '' '' 'poly1'%'sum,\',\',' 'poly1'%'sum2,' '\',\',' 'percy'%'sum,' '\',\',' 'nclust'%'sum,' '\',\',' 'nclust'%'sum2
echo 
...
echo ' '' '' '' '!' ''*''*'' 'Order' 'Parameters' ''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*'
echo ' '' '' '' 'call' 'accumulate_order' '"("poly1'%'value,' 'poly1aa'%'value,' 'poly1abba'%'value,' 'poly1bb'%'value,' 'h2ts'%'value,' ''&'
...
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'potential' '=' 'potential' '+' 'epsilon2
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"("rij' ''<'' 'sigma3")"' 'then' '!' 'if' 'the' 'pair' 'is' 'within' 'the' 'second,' 'inner-middle' 'well' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'if' '"(""("square"("i")"'%'circle"("m")"'%'pol' ''*'' 'square"("j")"'%'circle"("n")"'%'pol")"' '==' '-1")"' 'then' '!' 'if' 'the' 'spheres' 'are' 'attracted' 'to
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'potential' '=' 'potential' '-' 'epsilon3
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"(""("square"("i")"'%'circle"("m")"'%'pol' ''*'' 'square"("j")"'%'circle"("n")"'%'pol")"' '==' '1")"' 'then' '!' 'if' 'the' 'spheres' 'are' 'repulsed' 'from
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'potential' '=' 'potential' '+' 'epsilon3
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"("rij' ''<'' 'sigma4")"' 'then' '!' 'the' 'pair' 'is' 'within' 'the' 'third,' 'outer-middle' 'well
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'if' '"(""("square"("i")"'%'circle"("m")"'%'pol' ''*'' 'square"("j")"'%'circle"("n")"'%'pol")"' '==' '-1")"' 'then' '!' 'if' 'the' 'spheres' 'are' 'attracted' 'to
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'potential' '=' 'potential' '-' 'epsilon4
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"(""("square"("i")"'%'circle"("m")"'%'pol' ''*'' 'square"("j")"'%'circle"("n")"'%'pol")"' '==' '1")"' 'then' '!' 'if' 'the' 'spheres' 'are' 'repulsed' 'from
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'potential' '=' 'potential' '+' 'epsilon4
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"("rij' ''<'' 'sigma5")"' 'then' '!' 'the' 'pair' 'is' 'within' 'the' 'fourth,' 'outermost' 'well
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'if' '"(""("square"("i")"'%'circle"("m")"'%'pol' ''*'' 'square"("j")"'%'circle"("n")"'%'pol")"' '==' '-1")"' 'then' '!' 'if' 'the' 'spheres' 'are' 'attracted' 'to
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'potential' '=' 'potential' '-' 'epsilon5
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'else' 'if' '"(""("square"("i")"'%'circle"("m")"'%'pol' ''*'' 'square"("j")"'%'circle"("n")"'%'pol")"' '==' '1")"' 'then' '!' 'if' 'the' 'spheres' 'are' 'repulsed' 'from
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'potential' '=' 'potential' '+' 'epsilon5
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if
...
echo 
echo subroutine' 'accumulate_order"("poly1,' 'aa,' 'abba,' 'bb,' 'head2tailsame,' 'head2tailoppo,' 'antiparallel,' 'poly2,' ''&'
...
echo end' 'subroutine' 'accumulate_order
echo 
echo !' '//' 'percolation' '//' '
echo 
...
echo ' '' '' '' 'real"("kind=dbl")",' 'parameter' '::' 'cluster_dist' '=' 'sigma5
...
echo ' '' '' '' 'type"("position")",' 'dimension"("mer' '-' '2")"' '::' 'rcircles' '!' 'position' 'of' 'the' 'group' 'of' 'particles' 'making' 'up' 'the' 'square
...
echo ' '' '' '' '' '' '' '' 'if' '"("dr'%'r"("2")"' ''<'' '0")"' 'phi"("i")"' '=' '-phi"("i")"' '!' 'DEBUG
echo ' '' '' '' 'end' 'do
echo 
...
echo ' '' '' '' '' '' '' '' 'if' '"("pol1bonded' '"("a'%'two,' 'b'%'two")"")"' 'then' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'prediction' '=' 'pol1bond_event' '"("rij,' 'vij,' 'b'%'one,' 'b'%'two")"
echo ' '' '' '' '' '' '' '' 'else' 'if' '"("pol2bonded' '"("a'%'two,' 'b'%'two")"")"' 'then' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'prediction' '=' 'pol2bond_event' '"("rij,' 'vij,' 'b'%'one,' 'b'%'two")"
echo ' '' '' '' '' '' '' '' 'else' 'if' '"("neighborbonded' '"("a'%'two,' 'b'%'two")"")"' 'then' '
...
echo ' '' '' '' '' '' '' '' 'else' 'if' '"(""("square"("a'%'one")"'%'circle"("a'%'two")"'%'pol' '==' '0")"' '.and.' '"("square"("b'%'one")"'%'circle"("b'%'two")"'%'pol' '==' '0")"")"' 'then
...
echo ' '' '' '' '' '' '' '' '' '' '' '' 'neighborbond_event'%'type' '=' '10' '!' 'an' 'event' 'will' 'occur' 'at' 'the' 'inner' 'bond' 'length
echo ' '' '' '' '' '' '' '' '' '' '' '' 'neighborbond_event'%'time' '=' '"("-bij' '-' 'sqrt"("idiscr")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' 'else' '!' 'the' 'repulsive' 'centers' 'will' 'miss' 'each' 'other' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'neighborbond_event'%'type' '=' '11' '!' 'an' 'event' 'will' 'take' 'place' 'at' 'the' 'outer' 'bond' 'length
echo ' '' '' '' '' '' '' '' '' '' '' '' 'neighborbond_event'%'time' '=' '"("-bij' '+' 'sqrt"("odiscr")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' 'else' '!' 'the' 'centers' 'are' 'receding
echo ' '' '' '' '' '' '' '' 'neighborbond_event'%'type' '=' '11' '!' 'an' 'event' 'will' 'occur' 'at' 'the' 'outer' 'bond' 'length' '
echo ' '' '' '' '' '' '' '' 'neighborbond_event'%'time' '=' '"("-bij' '+' 'sqrt"("odiscr")"")"' '/' 'aij
echo ' '' '' '' 'end' 'if' '
...
echo ' '' '' '' 'if' '"("bij' ''<'' '0.")"' 'then' '!' 'the' 'centers' 'are' 'approaching
echo ' '' '' '' '' '' '' '' 'if' '"("idiscr' ''>'' '0.")"' 'then' '!' 'the' 'centers' 'will' 'collide' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'crossbond_event'%'type' '=' '12' '!' 'an' 'event' 'will' 'occur' 'at' 'the' 'inner' 'bond' 'length
echo ' '' '' '' '' '' '' '' '' '' '' '' 'crossbond_event'%'time' '=' '"("-bij' '-' 'sqrt"("idiscr")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' 'else' '!' 'the' 'repulsive' 'centers' 'will' 'miss' 'each' 'other' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'crossbond_event'%'type' '=' '13' '!' 'an' 'event' 'will' 'take' 'place' 'at' 'the' 'outer' 'bond' 'length
echo ' '' '' '' '' '' '' '' '' '' '' '' 'crossbond_event'%'time' '=' '"("-bij' '+' 'sqrt"("odiscr")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' 'else' '!' 'the' 'centers' 'are' 'receding
echo ' '' '' '' '' '' '' '' 'crossbond_event'%'type' '=' '13' '!' 'an' 'event' 'will' 'occur' 'at' 'the' 'outer' 'bond' 'length' '
echo ' '' '' '' '' '' '' '' 'crossbond_event'%'time' '=' '"("-bij' '+' 'sqrt"("odiscr")"")"' '/' 'aij
echo ' '' '' '' 'end' 'if' '
echo end' 'function' 'crossbond_event
echo 
echo type"("event")"' 'function' 'pol1bond_event' '"("rij,' 'vij,' 'j,' 'n")"
echo ' '' '' '' 'implicit' 'none' '' '
echo ' '' '' '' '!' ''*''*'' 'calling' 'variables' ''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*'
echo ' '' '' '' 'type"("position")",' 'intent"("in")"' '::' 'rij' '
echo ' '' '' '' 'type"("velocity")",' 'intent"("in")"' '::' 'vij' '
...
echo 
echo ' '' '' '' '!' 'determine' 'the' 'event' 'partner
echo ' '' '' '' 'pol1bond_event'%'partner'%'one' '=' 'j
echo ' '' '' '' 'pol1bond_event'%'partner'%'two' '=' 'n
echo 
echo ' '' '' '' '!' 'calculate' 'quadratic' 'parameters' '
echo ' '' '' '' 'aij' '=' '"("vij'%'v"("1")"' ''*''*'' '2")"' '+' '"("vij'%'v"("2")"' ''*''*'' '2")"
echo ' '' '' '' 'bij' '=' '"("rij'%'r"("1")"' ''*'' 'vij'%'v"("1")"")"' '+' '"("rij'%'r"("2")"' ''*'' 'vij'%'v"("2")"")"
echo ' '' '' '' 'icij' '=' '"("rij'%'r"("1")"' ''*''*'' '2")"' '+' '"("rij'%'r"("2")"' ''*''*'' '2")"' '-' '"("ipol1bond' ''*''*'' '2")"
echo ' '' '' '' 'ocij' '=' '"("rij'%'r"("1")"' ''*''*'' '2")"' '+' '"("rij'%'r"("2")"' ''*''*'' '2")"' '-' '"("opol1bond' ''*''*'' '2")"
echo ' '' '' '' 'idiscr' '=' '"("bij' ''*''*'' '2")"' '-' '"("aij' ''*'' 'icij")"
echo ' '' '' '' 'odiscr' '=' '"("bij' ''*''*'' '2")"' '-' '"("aij' ''*'' 'ocij")"
echo 
echo ' '' '' '' '!' 'determine' 'the' 'event' 'type' 'and' 'time' '
echo ' '' '' '' 'if' '"("bij' ''<'' '0.")"' 'then' '!' 'the' 'centers' 'are' 'approaching
echo ' '' '' '' '' '' '' '' 'if' '"("idiscr' ''>'' '0.")"' 'then' '!' 'the' 'centers' 'will' 'collide' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'pol1bond_event'%'type' '=' '14' '!' 'an' 'event' 'will' 'occur' 'at' 'the' 'inner' 'bond' 'length
echo ' '' '' '' '' '' '' '' '' '' '' '' 'pol1bond_event'%'time' '=' '"("-bij' '-' 'sqrt"("idiscr")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' 'else' '!' 'the' 'repulsive' 'centers' 'will' 'miss' 'each' 'other' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'pol1bond_event'%'type' '=' '15' '!' 'an' 'event' 'will' 'take' 'place' 'at' 'the' 'outer' 'bond' 'length
echo ' '' '' '' '' '' '' '' '' '' '' '' 'pol1bond_event'%'time' '=' '"("-bij' '+' 'sqrt"("odiscr")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' 'else' '!' 'the' 'centers' 'are' 'receding
echo ' '' '' '' '' '' '' '' 'pol1bond_event'%'type' '=' '15' '!' 'an' 'event' 'will' 'occur' 'at' 'the' 'outer' 'bond' 'length' '
echo ' '' '' '' '' '' '' '' 'pol1bond_event'%'time' '=' '"("-bij' '+' 'sqrt"("odiscr")"")"' '/' 'aij
echo ' '' '' '' 'end' 'if' '
echo end' 'function' 'pol1bond_event
echo 
echo type"("event")"' 'function' 'pol2bond_event' '"("rij,' 'vij,' 'j,' 'n")"
echo ' '' '' '' 'implicit' 'none' '' '
echo ' '' '' '' '!' ''*''*'' 'calling' 'variables' ''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*'
echo ' '' '' '' 'type"("position")",' 'intent"("in")"' '::' 'rij' '
echo ' '' '' '' 'type"("velocity")",' 'intent"("in")"' '::' 'vij' '
...
echo 
echo ' '' '' '' '!' 'determine' 'the' 'event' 'partner
echo ' '' '' '' 'pol2bond_event'%'partner'%'one' '=' 'j
echo ' '' '' '' 'pol2bond_event'%'partner'%'two' '=' 'n
echo 
echo ' '' '' '' '!' 'calculate' 'quadratic' 'parameters' '
echo ' '' '' '' 'aij' '=' '"("vij'%'v"("1")"' ''*''*'' '2")"' '+' '"("vij'%'v"("2")"' ''*''*'' '2")"
echo ' '' '' '' 'bij' '=' '"("rij'%'r"("1")"' ''*'' 'vij'%'v"("1")"")"' '+' '"("rij'%'r"("2")"' ''*'' 'vij'%'v"("2")"")"
echo ' '' '' '' 'icij' '=' '"("rij'%'r"("1")"' ''*''*'' '2")"' '+' '"("rij'%'r"("2")"' ''*''*'' '2")"' '-' '"("ipol2bond' ''*''*'' '2")"
echo ' '' '' '' 'ocij' '=' '"("rij'%'r"("1")"' ''*''*'' '2")"' '+' '"("rij'%'r"("2")"' ''*''*'' '2")"' '-' '"("opol2bond' ''*''*'' '2")"
echo ' '' '' '' 'idiscr' '=' '"("bij' ''*''*'' '2")"' '-' '"("aij' ''*'' 'icij")"
echo ' '' '' '' 'odiscr' '=' '"("bij' ''*''*'' '2")"' '-' '"("aij' ''*'' 'ocij")"
echo 
echo ' '' '' '' '!' 'determine' 'the' 'event' 'type' 'and' 'time' '
echo ' '' '' '' 'if' '"("bij' ''<'' '0.")"' 'then' '!' 'the' 'centers' 'are' 'approaching
echo ' '' '' '' '' '' '' '' 'if' '"("idiscr' ''>'' '0.")"' 'then' '!' 'the' 'centers' 'will' 'collide' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'pol2bond_event'%'type' '=' '16' '!' 'an' 'event' 'will' 'occur' 'at' 'the' 'inner' 'bond' 'length
echo ' '' '' '' '' '' '' '' '' '' '' '' 'pol2bond_event'%'time' '=' '"("-bij' '-' 'sqrt"("idiscr")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' 'else' '!' 'the' 'repulsive' 'centers' 'will' 'miss' 'each' 'other' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'pol2bond_event'%'type' '=' '17' '!' 'an' 'event' 'will' 'take' 'place' 'at' 'the' 'outer' 'bond' 'length
echo ' '' '' '' '' '' '' '' '' '' '' '' 'pol2bond_event'%'time' '=' '"("-bij' '+' 'sqrt"("odiscr")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' 'else' '!' 'the' 'centers' 'are' 'receding
echo ' '' '' '' '' '' '' '' 'pol2bond_event'%'type' '=' '17' '!' 'an' 'event' 'will' 'occur' 'at' 'the' 'outer' 'bond' 'length' '
echo ' '' '' '' '' '' '' '' 'pol2bond_event'%'time' '=' '"("-bij' '+' 'sqrt"("odiscr")"")"' '/' 'aij
echo ' '' '' '' 'end' 'if' '
echo end' 'function' 'pol2bond_event
echo 
...
echo ' '' '' '' 'integer,' 'intent"("in")"' '::' 'n' '!' 'uplist' 'particle' 'of' 'uplist' 'group' '
echo ' '' '' '' '!' ''*''*'' 'local' 'variables' ''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*''*'
echo ' '' '' '' 'real"("kind=dbl")"' '::' 'aij,' 'bij,' 'cij_1,' 'cij_2,' 'cij_3,' 'cij_4,' 'cij_5' '!' 'quadratic' 'equation' 'constants' 'wrt' 'to' 'discontinuities' '1,' '2,' '3,' '4,' 'and' '5
echo ' '' '' '' 'real"("kind=dbl")"' '::' 'discr1,' 'discr2,' 'discr3,' 'discr4,' 'discr5' '!' 'discrimenant' 'wrt' 'cij_1,' '_2,' '_3,' '_4,' 'and' '_5
echo 
echo ' '' '' '' '!' 'determine' 'the' 'event' 'partner
...
echo ' '' '' '' 'cij_4' '=' '"("rij'%'r"("1")"' ''*''*'' '2")"' '+' '"("rij'%'r"("2")"' ''*''*'' '2")"' '-' 'sg4sq' '!' 'fourth' 'discontinuity
echo ' '' '' '' 'cij_5' '=' '"("rij'%'r"("1")"' ''*''*'' '2")"' '+' '"("rij'%'r"("2")"' ''*''*'' '2")"' '-' 'sg5sq' '!' 'fifth' 'discontinuity
echo ' '' '' '' 'discr1' '=' '"("bij' ''*''*'' '2")"' '-' '"("aij' ''*'' 'cij_1")"
echo ' '' '' '' 'discr2' '=' '"("bij' ''*''*'' '2")"' '-' '"("aij' ''*'' 'cij_2")"
echo ' '' '' '' 'discr3' '=' '"("bij' ''*''*'' '2")"' '-' '"("aij' ''*'' 'cij_3")"
echo ' '' '' '' 'discr4' '=' '"("bij' ''*''*'' '2")"' '-' '"("aij' ''*'' 'cij_4")"
echo ' '' '' '' 'discr5' '=' '"("bij' ''*''*'' '2")"' '-' '"("aij' ''*'' 'cij_5")"
echo 
...
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '!' 'no' 'hard' 'sphere' 'events' 'can' 'occur' 'between' 'polarized' 'charges,' 'as' 'they' 'are' 'located' 'inside' 'the' 'hard' 'sphere
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event' '=' 'reset_event' '"("")"
...
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' '' '' '' '' 'else' 'if' '"("cij_4' ''<'' '0.0")"' 'then' '!' 'if' 'rij' 'is' 'within' 'the' 'third' 'well
echo ' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("discr3' ''>'' '0.0")"' 'then' '!' 'if' 'the' 'cores' 'will' 'collide
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'type' '=' '5' '!' 'an' 'event' 'will' 'take' 'place' 'at' 'sigma3+
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'time' '=' '"("-bij' '-' 'sqrt"("discr3")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' '' '' '' '' 'else' '!' 'the' 'cores' 'will' 'miss' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'type' '=' '6' '!' 'an' 'event' 'will' 'take' 'place' 'at' 'sigma4-
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'time' '=' '"("-bij' '+' 'sqrt"("discr4")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' '' '' '' '' 'else' 'if' '"("cij_5' ''<'' '0.0")"' 'then' '!' 'if' 'rij' 'is' 'within' 'the' 'fourth' 'well
echo ' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("discr4' ''>'' '0.0")"' 'then' '!' 'if' 'the' 'cores' 'will' 'collide
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'type' '=' '7' '!' 'an' 'event' 'will' 'take' 'place' 'at' 'sigma4+
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'time' '=' '"("-bij' '-' 'sqrt"("discr4")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' '' '' '' '' 'else' '!' 'the' 'cores' 'will' 'miss' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'type' '=' '8' '!' 'an' 'event' 'will' 'take' 'place' 'at' 'sigma5-
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'time' '=' '"("-bij' '+' 'sqrt"("discr5")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' '' '' '' '' 'else' '!' 'rij' 'is' 'outside' 'the' 'potential
echo ' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("discr5' ''>'' '0.0")"' 'then' '!' 'if' 'the' 'cores' 'will' 'collide
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'type' '=' '9' '!' 'an' 'event' 'will' 'take' 'place' 'at' 'sigma5+
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'time' '=' '"("-bij' '-' 'sqrt"("discr5")"")"' '/' 'aij
...
echo ' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'time' '=' '"("-bij' '+' 'sqrt"("discr2")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' 'else' 'if' '"("cij_3' ''<'' '0.0")"' 'then' '!' 'if' 'rij' 'is' 'within' 'the' 'second' 'well
echo ' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'type' '=' '4' '!' 'en' 'event' 'will' 'take' 'place' 'at' 'sigma3-
echo ' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'time' '=' '"("-bij' '+' 'sqrt"("discr3")"")"' '/' 'aij
echo ' '' '' '' '' '' '' '' 'else' 'if' '"("cij_4' ''<'' '0.0")"' 'then' '!if' 'rij' 'is' 'within' 'the' 'third' 'well
echo ' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'type' '=' '6' '!' 'an' 'event' 'will' 'take' 'place' 'at' 'sigma4-
echo ' '' '' '' '' '' '' '' '' '' '' '' 'polsphere_event'%'time' '=' '"("-bij' '+' 'sqrt"("discr4")"")"' '/' 'aij
...
echo ' '' '' '' 'real"("kind=dbl")"' '::' 'bij,' 'distance,' 'bump,' 'discr2,' 'discr3,' 'discr4,' 'discr5,' 'delep' '!' 'dot' 'prroduct' 'of' 'moment' 'and' 'velocity' 'vectors,' 'distance' 'between' 'atoms
...
echo ' '' '' '' '' '' '' '' 'end' 'if
echo ' '' '' '' '' '' '' '' 'n_well' '=' 'n_well' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '6")"' 'then' '!' 'the' 'event' 'is' 'a' 'collision' 'at' 'sigma' '4-
echo ' '' '' '' '' '' '' '' 'delep' '=' 'epsilon4' '-' 'epsilon5
echo ' '' '' '' '' '' '' '' 'if' '"(""("square"("a'%'one")"'%'circle"("a'%'two")"'%'pol' ''*'' 'square"("b'%'one")"'%'circle"("b'%'two")"'%'pol")"' '==' '-1")"' 'then' '!' 'if' 'the' 'spheres' 'are' 'attracted' 'to' 'one' 'another
echo ' '' '' '' '' '' '' '' '' '' '' '' '!' 'determine' 'if' 'the' 'spheres' 'have' 'enough' 'energy' 'required' 'to' 'dissociate
echo ' '' '' '' '' '' '' '' '' '' '' '' 'discr4' '=' 'bij'*''*'2' '-' '"("4.'*'sg4sq'*'delep")"
echo ' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("discr4' ''>'=' '0")"' 'then' '!' 'if' 'the' 'pair' 'meet' 'the' 'energy' 'requirement
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'pair' 'will' 'dissociate
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"(""("bij' '-' 'sqrt"("discr4")"")"' '/' '"("2.' ''*'' 'sg4sq")"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '1.0
echo ' '' '' '' '' '' '' '' '' '' '' '' 'else' '!' 'the' 'pair' 'will' 'remain' 'associated' '"("\"bounce\"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'sg4sq")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' '' '' '' '' 'else' '!' 'the' 'spheres' 'are' 'repeled' 'from' 'one' 'another
echo ' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'pair' 'will' 'dissociate
echo ' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"(""("bij' '-' 'sqrt"(""("bij' ''*''*'' '2")"' '+' '"("4.' ''*'' 'sg4sq' ''*'' 'delep")"")"")"' '/' '"("2.' ''*'' 'sg4sq")"")"' '!' 'CHECK' 'THIS!
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '1.0
echo ' '' '' '' '' '' '' '' 'end' 'if
echo ' '' '' '' '' '' '' '' 'n_well' '=' 'n_well' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '7")"' 'then' '!' 'the' 'event' 'is' 'a' 'collision' 'at' 'sigma' '4+
echo ' '' '' '' '' '' '' '' 'delep' '=' 'epsilon4' '-' 'epsilon5
echo ' '' '' '' '' '' '' '' 'if' '"(""("square"("a'%'one")"'%'circle"("a'%'two")"'%'pol' ''*'' 'square"("b'%'one")"'%'circle"("b'%'two")"'%'pol")"' '==' '-1")"' 'then' '!' 'if' 'the' 'spheres' 'are' 'attracted' 'to' 'one' 'another
echo ' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'pair' 'will' 'associate' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"(""("bij' '+' 'sqrt"(""("bij' ''*''*'' '2")"' '+' '"("4.' ''*'' 'sg4sq' ''*'' 'delep")"")"")"' '/' '"("2.' ''*'' '"("sg4sq")"")"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' 'else' '!' 'the' 'spheres' 'are' 'repeled' 'from' 'one' 'another' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '!' 'determine' 'if' 'the' 'spheres' 'have' 'enough' 'energy' 'required' 'to' 'associate' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'discr4' '=' '"("bij' ''*''*'' '2")"' '-' '"("4.' ''*'' 'sg4sq' ''*'' 'delep")"
echo ' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("discr4' ''>'=' '0")"' 'then' '!' 'the' 'the' 'pair' 'meet' 'the' 'energy' 'requirement
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'pair' 'will' 'associate
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"(""("bij' '+' 'sqrt"("discr4")"")"' '/"("2.' ''*'' 'sg4sq")"")"' '!' 'CHECK' 'THIS
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' '' '' '' '' 'else' '!' 'the' 'pair' 'do' 'not' 'meet' 'the' 'energy' 'requirement
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'pair' 'will' 'remain' 'dissociated' '"("\"bounce\"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'sg4sq")"' '!' 'CHECK' 'THIS
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '1.0
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' '' '' '' '' 'end' 'if
echo ' '' '' '' '' '' '' '' 'n_well' '=' 'n_well' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '8")"' 'then' '!' 'the' 'event' 'is' 'a' 'collision' 'at' 'sigma' '5-
echo ' '' '' '' '' '' '' '' 'delep' '=' 'epsilon5
echo ' '' '' '' '' '' '' '' 'if' '"(""("square"("a'%'one")"'%'circle"("a'%'two")"'%'pol' ''*'' 'square"("b'%'one")"'%'circle"("b'%'two")"'%'pol")"' '==' '-1")"' 'then' '!' 'if' 'the' 'spheres' 'are' 'attracted' 'to' 'one' 'another
echo ' '' '' '' '' '' '' '' '' '' '' '' '!' 'determine' 'if' 'the' 'spheres' 'have' 'enough' 'energy' 'required' 'to' 'dissociate
echo ' '' '' '' '' '' '' '' '' '' '' '' 'discr5' '=' 'bij'*''*'2' '-' '"("4.'*'sg5sq'*'delep")"
echo ' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("discr5' ''>'=' '0")"' 'then' '!' 'if' 'the' 'pair' 'meet' 'the' 'energy' 'requirement
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'pair' 'will' 'dissociate
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"(""("bij' '-' 'sqrt"("discr5")"")"' '/' '"("2.' ''*'' 'sg5sq")"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '1.0
echo ' '' '' '' '' '' '' '' '' '' '' '' 'else' '!' 'the' 'pair' 'will' 'remain' 'associated' '"("\"bounce\"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'sg5sq")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' '' '' '' '' 'else' '!' 'the' 'spheres' 'are' 'repeled' 'from' 'one' 'another
echo ' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'pair' 'will' 'dissociate
echo ' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"(""("bij' '-' 'sqrt"(""("bij' ''*''*'' '2")"' '+' '"("4.' ''*'' 'sg5sq' ''*'' 'delep")"")"")"' '/' '"("2.' ''*'' 'sg5sq")"")"' '!' 'CHECK' 'THIS!
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '1.0
echo ' '' '' '' '' '' '' '' 'end' 'if
echo ' '' '' '' '' '' '' '' 'n_well' '=' 'n_well' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '9")"' 'then' '!' 'the' 'event' 'is' 'a' 'collision' 'at' 'sigma' '5+
echo ' '' '' '' '' '' '' '' 'delep' '=' 'epsilon5
echo ' '' '' '' '' '' '' '' 'if' '"(""("square"("a'%'one")"'%'circle"("a'%'two")"'%'pol' ''*'' 'square"("b'%'one")"'%'circle"("b'%'two")"'%'pol")"' '==' '-1")"' 'then' '!' 'if' 'the' 'spheres' 'are' 'attracted' 'to' 'one' 'another
echo ' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'pair' 'will' 'associate' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"(""("bij' '+' 'sqrt"(""("bij' ''*''*'' '2")"' '+' '"("4.' ''*'' 'sg5sq' ''*'' 'delep")"")"")"' '/' '"("2.' ''*'' '"("sg5sq")"")"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' 'else' '!' 'the' 'spheres' 'are' 'repeled' 'from' 'one' 'another' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '!' 'determine' 'if' 'the' 'spheres' 'have' 'enough' 'energy' 'required' 'to' 'associate' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'discr5' '=' '"("bij' ''*''*'' '2")"' '-' '"("4.' ''*'' 'sg5sq' ''*'' 'delep")"
echo ' '' '' '' '' '' '' '' '' '' '' '' 'if' '"("discr5' ''>'=' '0")"' 'then' '!' 'the' 'the' 'pair' 'meet' 'the' 'energy' 'requirement
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'pair' 'will' 'associate
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"(""("bij' '+' 'sqrt"("discr5")"")"' '/"("2.' ''*'' 'sg5sq")"")"' '!' 'CHECK' 'THIS
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' '' '' '' '' 'else' '!' 'the' 'pair' 'do' 'not' 'meet' 'the' 'energy' 'requirement
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '!' 'the' 'pair' 'will' 'remain' 'dissociated' '"("\"bounce\"")"
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'sg5sq")"' '!' 'CHECK' 'THIS
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' '' '' '' '' '' '' '' '' 'bump' '=' '1.0
echo ' '' '' '' '' '' '' '' '' '' '' '' 'end' 'if' '
echo ' '' '' '' '' '' '' '' 'end' 'if
echo ' '' '' '' '' '' '' '' 'n_well' '=' 'n_well' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '10")"' 'then' '!' 'the' 'event' 'is' 'at' 'the' 'repulsive' 'inner' 'neighbor' 'bond' 'length
echo ' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'inbond'*''*'2")"
echo ' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' 'bump' '=' '1.0
echo ' '' '' '' '' '' '' '' 'n_bond' '=' 'n_bond' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '11")"' 'then' '!' 'the' 'event' 'is' 'at' 'the' 'repulsive' 'outer' 'neighbor' 'bond' 'length
echo ' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'onbond'*''*'2")"
echo ' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' 'n_bond' '=' 'n_bond' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '12")"' 'then' '!' 'the' 'event' 'is' 'occuring' 'at' 'the' 'repulsive' 'inner' 'cross' 'bond' 'length' '
echo ' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'icbond'*''*'2")"
echo ' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' 'bump' '=' '1.0
echo ' '' '' '' '' '' '' '' 'n_bond' '=' 'n_bond' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '13")"' 'then' '!' 'the' 'event' 'is' 'occuring' 'at' 'the' 'repulsive' 'outer' 'cross' 'bond' 'length
echo ' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'ocbond'*''*'2")"
echo ' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' 'n_bond' '=' 'n_bond' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '14")"' 'then' '!' 'the' 'event' 'is' 'occuring' 'at' 'the' 'repulsive' 'inner' 'first' 'polarized' 'bond
echo ' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'ipol1bond'*''*'2")"
echo ' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' 'n_bond' '=' 'n_bond' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '15")"' 'then' '!' 'the' 'event' 'is' 'occuring' 'at' 'the' 'repulsive' 'outer' 'first' 'polarized' 'bond
echo ' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'opol1bond'*''*'2")"
echo ' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' 'n_bond' '=' 'n_bond' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '16")"' 'then' '!' 'the' 'event' 'is' 'occuring' 'at' 'the' 'repulsive' 'inner' 'second' 'polarized' 'bond
echo ' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'ipol2bond'*''*'2")"
echo ' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' 'n_bond' '=' 'n_bond' '+' '1
echo ' '' '' '' 'else' 'if' '"("this_event'%'type' '==' '17")"' 'then' '!' 'the' 'event' 'is' 'occuring' 'at' 'the' 'repulsive' 'outer' 'second' 'polarized' 'bond
echo ' '' '' '' '' '' '' '' 'do' 'q' '=' '1,' 'ndim' '
echo ' '' '' '' '' '' '' '' '' '' '' '' 'impulse"("q")"' '=' '-' 'rij'%'r"("q")"' ''*'' '"("bij' '/' 'opol2bond'*''*'2")"
echo ' '' '' '' '' '' '' '' 'end' 'do' '
echo ' '' '' '' '' '' '' '' 'bump' '=' '-1.0
echo ' '' '' '' '' '' '' '' 'n_bond' '=' 'n_bond' '+' '1
echo ' '' '' '' 'end' 'if' '
